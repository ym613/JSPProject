...
<!-- MY PAGE 상단 -->
<div class="jumbotron jumbotron-fluid mb-5 border-bottom-0 rounded-bottom text- pb-1
" style="background-color: #88a1e687">
	<div class="container pb-5" align="center">
		<h2><%=mMgr.getMember(id).getName()%> 님의 타이틀은</h2>
		<hr class="my-4">
...
<div class="container pt-5" style="margin-top: 50px;">
						...
						$('document').ready(function(){
						 ...
						 // 현재 총 지출액과 지출별 비교하여 bootstrap progress로 보여준다.
						    ...
						    if(perMax==foodPercent){
						    	printTagLocation.html('자주먹고 많이먹는');
						    }
						    if(perMax==transportationPercent){
						    	printTagLocation.html('동에번쩍 서에번쩍');
						    }
						    if(perMax==culturePercent){
						    	printTagLocation.html('문화를 즐길줄 아는');
						    }
						    if(perMax==shoppingPercent){
						    	printTagLocation.html('지름신 강림');
						    }
						    if(perMax==etcPercent){
						    	printTagLocation.html('이번달 예상치 못한 지출이 많았던');
						    }
	...
	<div class="row" style="margin-top: 80px;">
		<button type="button" class="btn btn-lg btn-block mb-3" 
		style="background-color: #88a1e687"
