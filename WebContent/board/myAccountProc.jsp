...
<%
	...
	for (int i = 0; i < jsonArray.size(); i++) {
		...
		System.out.println("res_lsit : fintech_use_num = > " + res_listObject.get("fintech_use_num"));
		System.out.println("res_lsit : account_alias = > " + res_listObject.get("account_alias"));
		System.out.println("res_lsit : bank_code_std = > " + res_listObject.get("bank_code_std"));
		System.out.println("res_lsit : bank_code_sub = > " + res_listObject.get("bank_code_sub"));
		System.out.println("res_lsit : bank_name = > " + res_listObject.get("bank_name"));
		System.out.println("res_lsit : account_num_masked = > " + res_listObject.get("account_num_masked"));
		System.out.println("res_lsit : account_holder_name = > " + res_listObject.get("account_holder_name"));
		System.out.println("res_lsit : account_type = > " + res_listObject.get("account_type"));
		System.out.println("res_lsit : inquiry_agree_yn = > " + res_listObject.get("inquiry_agree_yn"));
		System.out.println("res_lsit : inquiry_agree_dtime = > " + res_listObject.get("inquiry_agree_dtime"));
		System.out.println("res_lsit : transfer_agree_yn = > " + res_listObject.get("transfer_agree_yn"));
		System.out.println("res_lsit : transfer_agree_dtime = > " + res_listObject.get("transfer_agree_dtime"));
		System.out.println("res_lsit : account_state = > " + res_listObject.get("account_state"));
	}
%>
