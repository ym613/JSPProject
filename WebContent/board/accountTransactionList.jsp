...
<%
	...
	String jsonString = request.getParameter("json");
   	...
   	System.out.println("처음 JSON(String 형태) :\n"+jsonString);
...
<header>
	<div
		class="jumbotron jumbotron-fluid mb-5 border-bottom-0 rounded-bottom text-black bg-#88a1e687"
...
function foo(){
    ...
    for(var i = 0; i < data.length;i++){
    	...
    	if(dataMonth==month){
    		...
    		var cardBody = $('#canvas').append('<div id="card'+index+'" class="card mx-auto  bg-#88a1e687" style="max-width: 700px;"><div class="card-body row"></div></div>');
